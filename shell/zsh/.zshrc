...
# insecure directories you can set the variable ZSH_DISABLE_COMPFIX to "true" 
...
if [ -f '/Users/luis/dev/google-cloud-sdk/path.zsh.inc' ]; then . '/Users/luis/dev/google-cloud-sdk/path.zsh.inc'; fi
